...
public:
	...
	static int32_t CreateRenderTargetTexture(uint32_t width, uint32_t height, Float4 clearColor = {0.247f, 0.3f, 0.372f, 1.0f});
	...
	static void ClearRTV(int32_t textureHandle, Float4 clearColor = {0.247f, 0.3f, 0.372f, 1.0f});
